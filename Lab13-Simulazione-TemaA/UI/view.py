...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.btnVicini = ft.ElevatedButton(text="Vicini", on_click=self._controller.handle_vicini)
        row1 = ft.Row([self.ddyear,self.ddstate, self.btn_graph, self.btnVicini],
